...
{
    public class PMBall : ModProjectile
    {

        public override void DealtNPC(NPC npc, int hitDir, int dmgDealt, float knockback, bool crit)
        {
            int c1 = ProjDef.byName["jFlail:ChunkProj"].type;
            int c2 = ProjDef.byName["jFlail:ChunkProj2"].type;
            int c3 = ProjDef.byName["jFlail:ChunkProj3"].type;
            int c4 = ProjDef.byName["jFlail:ChunkProj4"].type;
